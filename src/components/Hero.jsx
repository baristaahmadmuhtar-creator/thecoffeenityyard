...
export const Hero = ({ openAI, openBulkInfo }) => {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden bg-old-lace py-12">
      ...
      {/* Background Decor */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-almond-silk/40 via-old-lace to-old-lace pointer-events-none"></div>
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-flag-red/5 rounded-full mix-blend-multiply filter blur-3xl animate-blob pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-tomato-jam/5 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000 pointer-events-none"></div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto text-left">
            ...
            <motion.div 
              ...
              className="group cursor-pointer bg-white p-8 rounded-[2rem] border border-almond-silk shadow-xl shadow-almond-silk/30 hover:shadow-2xl hover:border-flag-red transition-all flex flex-col justify-between h-full relative overflow-hidden"
            >
            ...
            <motion.div 
              whileHover={{ y: -5 }} whileTap={{ scale: 0.98 }}
              onClick={openAI}
              className="group cursor-pointer bg-slate-900 p-8 rounded-[2rem] border border-slate-800 shadow-2xl shadow-slate-900/20 hover:shadow-flag-red/20 transition-all flex flex-col justify-between h-full relative overflow-hidden"
            >
              <div className="absolute top-[-20%] right-[-20%] w-64 h-64 bg-flag-red/20 rounded-full blur-3xl pointer-events-none group-hover:bg-flag-red/30 transition-all duration-500"></div>
              ...
              <div className="mt-8 flex items-center text-almond-silk font-bold text-sm relative z-10 group-hover:text-white transition-colors">
